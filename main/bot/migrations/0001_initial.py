# Generated by Django 4.2.7 on 2024-03-21 16:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='bot.datelessonfit', verbose_name='Промежуточное расписание')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='Имя')),
                ('last_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='Фамилия')),
                ('lesson', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='bot.lessonfit', verbose_name='Занятия')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='time',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='bot.timelessonfit', verbose_name='Дата и время занятия'),
        ),
    ]
