...
class TelegramUser(models.Model):
    ...
    username = models.CharField(
        max_length=20, blank=True, null=True, verbose_name="Никнейм"
    )
...
class UserFit(models.Model):
    ...
    card = models.PositiveIntegerField(
        blank=True, null=True, verbose_name="Номер карты", db_index=True
    )
    first_name = models.CharField(
        max_length=20, blank=True, null=True, verbose_name="Имя", db_index=True
    )
    last_name = models.CharField(
        max_length=20, blank=True, null=True, verbose_name="Фамилия", db_index=True
    )
...
class LessonFit(models.Model):
    ...
    title = models.CharField(
        max_length=25, blank=True, null=True, verbose_name="Название", db_index=True
    )
...
class DateLessonFit(models.Model):
    ...
    schedule = ImageOrDocumentField(
        upload_to="bot/lesson_schedule/", verbose_name="Расписание"
    )
